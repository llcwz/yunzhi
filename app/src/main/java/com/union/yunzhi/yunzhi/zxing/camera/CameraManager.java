...
package com.union.yunzhi.yunzhi.zxing.camera;
...
import com.union.yunzhi.yunzhi.zxing.app.PreferencesActivity;
import com.union.yunzhi.yunzhi.zxing.decode.PlanarYUVLuminanceSource;
...
public final class CameraManager {
	...
	public void requestAutoFocus(Handler handler, int message) {
		if (camera != null && previewing) {
			...
			// Log.d(KEY, "Requesting auto-focus callback");
